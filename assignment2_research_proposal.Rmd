...
setwd("~/Dropbox/4_Spring_2016/2_Collaborative Data Analysis/Assignment-2---Philip-Philipp")
...
# Packages used
In order to render this Rmd-file we use R [@CiteR] as well as the following packages: "repmis" [@R-repmis] and "setspaces" [@setspaces].
